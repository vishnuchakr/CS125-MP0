            ...
            new LinkedHashMap<>() {
                {
                    ...
                    put(new QuizzerInput(true, false, false, false), 5);
                    put(new QuizzerInput(false, true, false, false), 5);

                    put(new QuizzerInput(true, true, true, false), 15);
                    put(new QuizzerInput(true, true, false, true), 15);
                    put(new QuizzerInput(true, false, true, true), 15);

                    put(new QuizzerInput(true, true, true, true), 20);
                }
            };

    /** Class to hold testing inputs and results. */
